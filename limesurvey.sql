...
--
-- Hôte : 127.0.0.1
-- Généré le :  jeu. 14 juin 2018 à 12:19
...
(92, 0, 526745, 12, 'L', 'D1433', '<h4>Contraste (minimum) -AA-</h4>\r\n<span style=\"font-family:&quot;Arial&quot;,sans-serif\"> </span>\r\n\r\n<span style=\"font-size:9pt\">S’applique à tous les textes et instructions, mais aussi aux bordures de champs et aux textes des graphiques. Font exception les logos, les nom d’entreprise et les textes purement décoratifs. </span>', '', '<div class=\"panel-group\">\r\n<div class=\"panel panel-default\">\r\n<div class=\"panel-heading\">\r\n<h4 class=\"panel-title\"><a data-toggle=\"collapse\" href=\"#aide\">Aide</a></h4>\r\n</div>\r\n\r\n<div class=\"panel-collapse collapse\" id=\"aide\">\r\n<div class=\"panel-body\">\r\n<p>Comprendre :</p>\r\n\r\n<p>Il est très important d\'avoir un contraste de couleurs suffisant pour que le texte soit lisible et qu\'il se détache bien de l\'arrière-plan. De nombreuses personnes malvoyantes procèdent à des réglages individuels supplémentaires, p. ex. l\'inversion des couleurs. Afin que ces réglages puissent produire les effets voulus, un contraste suffisant est nécessaire. Il faut en outre prêter une attention particulière aux liens changeant d\'apparence au survol du pointeur (pseudo-style hover) ainsi qu\'aux liens actifs et ayant le focus.</p>\r\n\r\n<p>Contraste minimum nécéssaire :</p>\r\n\r\n<p>Ecriture: rapport de contraste d\'au moins 4,5:1<br />\r\nEcriture de grande taille (à partir de 18 Pt ou de 14 Pt + gras): rapport d\'au moins 3:1 (également valable pour les textes dans des graphiques à contenu informatif, mais pas impératif pour les logotypes)</p>\r\n\r\n<p>Remarque sur la taille de la police :</p>\r\n\r\n<p>Peu habituel, le Mass Point (Pt) est utilisé par la WAI. Voici comment il se calcule: avec un écran dont la résolution est de 1200 x 900 pixels, la taille 18 Point correspond au moins à 5,3 mm de hauteur pour le W majuscule; la taille 14 Pt et gras correspond au moins à 4 mm de hauteur pour le W majuscule gras.</p>\r\n</div>\r\n</div>\r\n</div>\r\n</div>\r\n', 'N', 'Y', 5, 'fr', 0, 0, '1', NULL),
...
(159, 47, 'question_template', 'radio_accessible', NULL),
(146, 70, 'question_template', 'radio_accessible', NULL),
(75, 27, 'min_answers', '1', NULL),
(160, 48, 'question_template', 'radio_accessible', NULL),
(166, 49, 'question_template', 'radio_accessible', NULL),
(168, 50, 'question_template', 'radio_accessible', NULL),
(169, 51, 'question_template', 'radio_accessible', NULL),
(176, 85, 'question_template', 'radio_accessible', NULL),
(175, 53, 'question_template', 'radio_accessible', NULL),
(182, 89, 'question_template', 'radio_accessible', NULL),
(179, 88, 'question_template', 'radio_accessible', NULL),
(178, 87, 'question_template', 'radio_accessible', NULL),
(180, 57, 'question_template', 'radio_accessible', NULL),
(181, 58, 'question_template', 'radio_accessible', NULL),
(190, 95, 'question_template', 'radio_accessible', NULL),
(192, 97, 'question_template', 'radio_accessible', NULL),
(187, 62, 'question_template', 'radio_accessible', NULL),
(188, 93, 'question_template', 'radio_accessible', NULL),
(189, 94, 'question_template', 'radio_accessible', NULL),
...
(172, 82, 'question_template', 'radio_accessible', NULL),
(171, 83, 'question_template', 'radio_accessible', NULL),
(174, 84, 'question_template', 'radio_accessible', NULL),
(177, 86, 'question_template', 'radio_accessible', NULL),
(183, 90, 'question_template', 'radio_accessible', NULL),
(186, 91, 'question_template', 'radio_accessible', NULL),
(185, 92, 'question_template', 'radio_accessible', NULL),
(191, 96, 'question_template', 'radio_accessible', NULL),
(193, 98, 'question_template', 'radio_accessible', NULL),
(194, 99, 'question_template', 'radio_accessible', NULL),
(195, 100, 'question_template', 'radio_accessible', NULL),
(196, 101, 'question_template', 'radio_accessible', NULL),
(197, 102, 'question_template', 'radio_accessible', NULL),
(198, 103, 'question_template', 'radio_accessible', NULL),
(199, 104, 'question_template', 'radio_accessible', NULL),
(200, 105, 'question_template', 'radio_accessible', NULL);
...
('last_question_gid_1', '12'),
('last_question_1', '105'),
('last_question_1_526745_gid', '12'),
('admintheme', 'Bay_of_Many'),
('last_question_1_526745', '105');
...
--
ALTER TABLE `lime_questions`
  MODIFY `qid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=106;

--
-- AUTO_INCREMENT pour la table `lime_question_attributes`
--
ALTER TABLE `lime_question_attributes`
  MODIFY `qaid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=201;
